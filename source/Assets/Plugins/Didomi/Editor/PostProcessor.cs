...
class PostProcessorGradleAndroidProject : IPostGenerateGradleAndroidProject
{
    ...
    /// <summary>
    /// Convert the Activity class generated by Unity to FragmentActivity as that is
    ...
    private static void UpdateUnityPlayerActivity(string path)
    {
        ...
        var newValue = $"import androidx.fragment.app.FragmentActivity;{System.Environment.NewLine}{System.Environment.NewLine}public class UnityPlayerActivity extends FragmentActivity implements IUnityPlayerLifecycleEvents";
        PostProcessor.ReplaceLineInFile(unityPlayerFileAbsolutePath, oldValue, newValue);
    }
}
