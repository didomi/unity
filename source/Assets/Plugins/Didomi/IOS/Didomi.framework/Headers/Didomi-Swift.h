...
///
/// \param agentSDKVersion Agent SDK Version.
///
- (void)setUserAgentWithAgentName:(NSString * _Nonnull)agentName agentSDKVersion:(NSString * _Nonnull)agentSDKVersion;
...
/// important:
/// Do not keep a local reference to the View Controller itself as that could create a memory leak
/// <ul>
///   <li>
